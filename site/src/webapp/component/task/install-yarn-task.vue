<template>
    <fgp-task name="installYarn">
        ...
        <template v-slot:description>
            If the <fgp-property-link name="yarnEnabled" /> property is <fgp-code>true</fgp-code>, the task downloads
            and install a <fgp-yarn-link /> distribution in the directory pointed by the
