<template>
    <fgp-task name="RunNpx" :type="true">
        ...
        <template v-slot:description>
            ...
            custom task to run a <fgp-code>npx</fgp-code> command. The <fgp-code>script</fgp-code> property must be set
            with the corresponding command. The task will fail if the <fgp-property-link name="yarnEnabled" /> property
            is <fgp-code>true</fgp-code>, to prevent unpredictable behaviors with mixed installation of dependencies.
            Then, choose whether <fgp-nodejs-link /> only is required, or if additional dependencies located in the
            ...
            hereafter shows the configuration required to output the version of <fgp-code>npx</fgp-code>:

            <fgp-gradle-scripts id="run-npx-example" class="mt-3">
