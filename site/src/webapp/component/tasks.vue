...
<script>
import Vue from "vue";
import fgpAssembleFrontendTask from "./task/assemble-frontend-task";
import fgpCheckFrontendTask from "./task/check-frontend-task";
import fgpCleanFrontendTask from "./task/clean-frontend-task";
import fgpCodeComment from "./layout/code-comment";
import fgpDependencyTree from "./task/dependency-tree";
import fgpGradleScripts from "./layout/gradle-scripts";
import fgpInstallFrontendTask from "./task/install-frontend-task";
import fgpInstallNodeTask from "./task/install-node-task";
import fgpInstallYarnTask from "./task/install-yarn-task";
import fgpPublishFrontendTask from "./task/publish-frontend-task";
import fgpRunNodeTaskType from "./task/run-node-task-type";
import fgpRunNpmYarnTaskType from "./task/run-npm-yarn-task-type";
import fgpRunNpxTaskType from "./task/run-npx-task-type";

export default Vue.component("fgp-tasks", {
    components: {
