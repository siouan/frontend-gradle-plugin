    ...
    <fgp-task name="checkFrontend">
        ...
        <template v-slot:description>
            <p>
                ...
                shall be set with the corresponding <fgp-code>npm</fgp-code>/<fgp-code>yarn</fgp-code> command. A
                typical check script may lint frontend source files, execute tests, and perform additional analysis
                actions. This task depends on the <fgp-task-link name="installFrontend" /> task, and is skipped if the
