<template>
    ...
    >
        ...
        <template #description>
            <p>
                This task allows to execute a <FgpCode>pnpm</FgpCode> command from a Gradle command line. It is
                recommended to register a custom task using <FgpTaskLink name="RunPnpmTaskType" /> to define custom
