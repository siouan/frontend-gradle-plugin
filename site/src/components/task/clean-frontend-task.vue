    ...
    <fgp-task name="cleanFrontend">
        ...
        <template v-slot:description>
            <p>
                ...
                HTML files...) are written in the <fgp-code>${project.buildDir}</fgp-code> directory. If it is not the
                ...
                be set with the corresponding <fgp-code>npm</fgp-code>/<fgp-code>yarn</fgp-code> command. This task
