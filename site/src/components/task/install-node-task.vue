    ...
    <FgpTask name="installNode" :inputs="inputs" :outputs="outputs">
        ...
        <template #description>
            <p>
                ...
                (resp. uses the <FgpCode>http</FgpCode> protocol). In case of connectivity/HTTP error, download of the
                distribution file and the shasum file may be retried using property
