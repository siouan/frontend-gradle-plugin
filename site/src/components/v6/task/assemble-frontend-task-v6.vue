<template>
    <FgpTask name="assembleFrontend">
        ...
        <template #description>
            ...
            shall be set with the corresponding <FgpCode>npm</FgpCode>/<FgpCode>yarn</FgpCode> command. This task
            depends on the <FgpTaskLink name="installFrontend" /> task, and is skipped if the
            ...
            <div class="card my-3">
                <div class="card-body">
                    ...
                    <p class="card-text">
                        ...
                        already <FgpGradleTaskOutcomeLink outcome="UP-TO-DATE" /> (e.g. unlike tasks
                        <FgpTaskLink name="installNode" /> and <FgpTaskLink name="installYarn" />). The task provides
                        the ability to plug the developer's own Javascript build process to Gradle, and nothing more.
                        Every Javascript build process is unique: it depends on the project, the languages involved
                        (e.g. TypeScript, JSX, ECMA script, SASS, SCSS...), the directory layout, the build utilities
                        (Webpack...), etc., chosen by the team. Moreover, some build utilities are already able to
                        build artifacts incrementally. The plugin does not duplicate this logic. If you are about to
                        tweak this task, take a look at these <FgpSiteLink
                            :path="`${$config.public.paths.tasks}#tweaking-tasks`">recommendations</FgpSiteLink>.
                    </p>
                </div>
            </div>
        </template>
