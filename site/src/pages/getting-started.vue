<template>
    <section>
        ...
        <fgp-info>
            ...
            the plugin, we recommend <fgp-repo-link path="/releases/tag/v6.0.1">upgrading</fgp-repo-link> to the latest
...
<pre><fgp-code>plugins {
    ...
    id 'org.siouan.frontend-jdk11' version '6.0.1'
    <fgp-code-comment>// For JDK 8+</fgp-code-comment>
    id 'org.siouan.frontend-jdk8' version '6.0.1'
}</fgp-code></pre>
                            </template>
...
<pre><fgp-code>buildscript {
    ...
    dependencies {
        <fgp-code-comment>// For JDK 11+</fgp-code-comment>
        classpath 'org.siouan:frontend-gradle-plugin-jdk11:6.0.1'
        <fgp-code-comment>// For JDK 8+</fgp-code-comment>
        classpath 'org.siouan:frontend-gradle-plugin-jdk8:6.0.1'
    }
}
