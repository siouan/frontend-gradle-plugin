<template>
    ...
    id 'org.siouan.frontend-jdk17' version '8.2.0'
    <FgpCodeComment>// For JDK 11+</FgpCodeComment>
    id 'org.siouan.frontend-jdk11' version '8.2.0'
}</FgpCode></pre>
                            </template>
                            <template #kotlin>
                                <pre><FgpCode>plugins {
    ...
    dependencies {
        <FgpCodeComment>// For JDK 21+</FgpCodeComment>
        classpath 'org.siouan:frontend-gradle-plugin-jdk21:8.2.0'
        <FgpCodeComment>// For JDK 17+</FgpCodeComment>
        classpath 'org.siouan:frontend-gradle-plugin-jdk17:8.2.0'
        <FgpCodeComment>// For JDK 11+</FgpCodeComment>
        classpath 'org.siouan:frontend-gradle-plugin-jdk11:8.2.0'
    }
}
