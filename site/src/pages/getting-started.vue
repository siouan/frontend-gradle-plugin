<template>
    <section>
        ...
        <fgp-info>
            ...
            the plugin, we recommend <fgp-repo-link path="/releases/tag/v4.0.2-jdk11">upgrading</fgp-repo-link> to the latest
            release as soon as possible.
        </fgp-info>
        <ol>
            <li>
                Install the plugin.
                <ul class="list-unstyled my-2 mr-3">
                    <li>
                        <p class="mb-2">
                            Using
                            <fgp-gradle-docs-link path="/current/userguide/plugins.html#sec:plugins_block">Gradle DSL</fgp-gradle-docs-link>
...
<pre><fgp-code>plugins {
    ...
    id 'org.siouan.frontend-jdk11' version '4.0.2'
    <fgp-code-comment>// For JDK 8+</fgp-code-comment>
    id 'org.siouan.frontend-jdk8' version '4.0.2'
}</fgp-code></pre>
                            </template>
...
<pre><fgp-code>buildscript {
    ...
    dependencies {
        <fgp-code-comment>// For JDK 11+</fgp-code-comment>
        classpath 'org.siouan:frontend-gradle-plugin-jdk11:4.0.2'
        <fgp-code-comment>// For JDK 8+</fgp-code-comment>
        classpath 'org.siouan:frontend-gradle-plugin-jdk8:4.0.2'
    }
}
