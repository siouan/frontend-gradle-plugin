<template>
    ...
    <FgpPropertyLink name="nodeVersion" /> = '14.17.3'
    ...
    <FgpPropertyLink name="yarnVersion" /> = '1.22.10'
    ...
    <FgpPropertyLink name="nodeVersion" />.set("14.17.3")
    ...
    <FgpPropertyLink name="yarnVersion" />.set("1.22.10")
    ...
    <FgpPropertyLink name="verboseModeEnabled" />.set(false)
        ...
        <section>
            ...
            <FgpNodeDistributionProvidedPropertyV5 />
            <FgpNodeVersionPropertyV6 />
            ...
            <FgpNodeInstallDirectoryPropertyV6 />
        </section>

        <section>
            <FgpSubSubTitle>Yarn settings</FgpSubSubTitle>

            <FgpYarnEnabledPropertyV5 />
            <FgpYarnDistributionProvidedPropertyV5 />
            <FgpYarnVersionPropertyV5 />
            <FgpYarnDistributionUrlRootPropertyV5 />
            <FgpYarnDistributionUrlPathPatternPropertyV5 />
            <FgpYarnDistributionServerUsernamePropertyV5 />
            <FgpYarnDistributionServerPasswordPropertyV5 />
            <FgpYarnInstallDirectoryPropertyV5 />
        </section>

        <section>
            <FgpSubSubTitle id="script-settings">Script settings</FgpSubSubTitle>
            <p>
                Depending on the value of the <FgpPropertyLink name="yarnEnabled" /> property, the value for each
                property hereafter is provided as argument either of the <FgpCode>npm</FgpCode> executable or the
                <FgpCode>yarn</FgpCode> executable.
            </p>
            <p>
...
// }</FgpCodeComment></FgpCode></pre>
        ...
        <section>
            ...
            <FgpPackageJsonDirectoryPropertyV5 />
...
const canonicalUrl = 'https://siouan.github.io/frontend-gradle-plugin/configuration';
const title = 'Configuring Gradle to build a Javascript application with node';
const description = 'Choose pre-installed packages or request Node.js/Yarn distributions download, plug scripts from a package.json file to build/test/publish frontend artifacts with Gradle.';
