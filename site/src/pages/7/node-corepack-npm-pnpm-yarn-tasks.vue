<template>
    <section>
        ...
        <section>
            ...
            <FgpInstallNodeTaskV7 />
            <FgpResolvePackageManagerTaskV7 />
            <FgpInstallPackageManagerTaskV7 />
            <FgpInstallFrontendTaskV7 />
            <FgpCleanFrontendTaskV7 />
            <FgpAssembleFrontendTaskV7 />
            <FgpCheckFrontendTaskV7 />
            <FgpPublishFrontendTaskV7 />
        </section>
