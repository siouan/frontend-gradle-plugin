<template>
    ...
    <FgpPropertyLink name="nodeVersion" /> = '18.16.0'
    ...
    <FgpPropertyLink name="nodeVersion" />.set("18.16.0")
    ...
    <FgpPropertyLink name="cacheDirectory" />.set(project.layout.projectDirectory.dir(".frontend-gradle-plugin"))
        ...
        <section>
            ...
            <FgpNodeDistributionProvidedPropertyV7 />
            ...
            <FgpNodeInstallDirectoryPropertyV7 />
        </section>
