<template>
    <section>
        <fgp-main-title class="text-center">
            ...
            <fgp-image-link
                href="https://github.com/siouan/frontend-gradle-plugin/releases/tag/v3.0.2"
                src="https://img.shields.io/badge/Latest%20release-3.0.2-blue.svg"
                alt="Latest release 3.0.2"
                class="ml-1"
            />
        </fgp-main-title>
