...
class FrontendGradlePluginTest {
    ...
    void shouldRegisterTasksWithDefaultExtensionValuesWhenApplied() {
        ...
        assertThat(extension.getNodeDistributionUrlRoot().get())
            .isEqualTo(FrontendGradlePlugin.DEFAULT_NODE_DISTRIBUTION_URL_ROOT);
        assertThat(extension.getNodeDistributionUrlPathPattern().get())
            .isEqualTo(FrontendGradlePlugin.DEFAULT_NODE_DISTRIBUTION_URL_PATH_PATTERN);
    ...
    private void assertThatTasksAreConfigured(@Nonnull final Project project,
        ...
        assertThat(nodeInstallTask.getNodeDistributionUrlRoot().get())
            .isEqualTo(extension.getNodeDistributionUrlRoot().get());
        assertThat(nodeInstallTask.getNodeDistributionUrlPathPattern().get())
            .isEqualTo(extension.getNodeDistributionUrlPathPattern().get());
        assertThat(nodeInstallTask.getNodeInstallDirectory().get())
            .isEqualTo(extension.getNodeInstallDirectory().get());
        assertThat(nodeInstallTask.getHttpsProxyHost().getOrNull())
            .isEqualTo(extension.getHttpsProxyHost().getOrNull());
        assertThat(nodeInstallTask.getHttpsProxyPort().get()).isEqualTo(extension.getHttpsProxyPort().get());
        assertThat(nodeInstallTask.getHttpsProxyUsername().getOrNull())
            .isEqualTo(extension.getHttpsProxyUsername().getOrNull());
        assertThat(nodeInstallTask.getHttpsProxyPassword().getOrNull())
            .isEqualTo(extension.getHttpsProxyPassword().getOrNull());
        ...
        assertThat(enableYarnBerryTask.getDependsOn()).containsExactlyInAnyOrder(yarnGlobalInstallTask.getName());

        final InstallYarnTask installYarnTask = project
            .getTasks()
            .named(FrontendGradlePlugin.YARN_INSTALL_TASK_NAME, InstallYarnTask.class)
            .get();
        ...
        final InstallDependenciesTask installDependenciesTask = project
            ...
            .get();
        assertThat(installDependenciesTask.getNodeInstallDirectory().getOrNull())
            .isEqualTo(extension.getNodeInstallDirectory().getOrNull());
        ...
        assertThat(installDependenciesTask.getPackageJsonDirectory().get())
            .isEqualTo(extension.getPackageJsonDirectory().get());
        assertThat(installDependenciesTask.getDependsOn())
            .containsExactlyInAnyOrder(nodeInstallTask.getName(), installYarnTask.getName());

        final CleanTask frontendCleanTask = project
            .getTasks()
            .named(FrontendGradlePlugin.CLEAN_TASK_NAME, CleanTask.class)
            .get();
        assertThat(frontendCleanTask.getNodeInstallDirectory().getOrNull())
            .isEqualTo(extension.getNodeInstallDirectory().getOrNull());
        ...
        assertThat(frontendCleanTask.getPackageJsonDirectory().get())
            .isEqualTo(extension.getPackageJsonDirectory().get());
        ...
        assertThat(project.getTasks().named(BasePlugin.CLEAN_TASK_NAME).get().getDependsOn())
        ...
        final AssembleTask frontendAssembleTask = project
            ...
            .get();
        assertThat(frontendAssembleTask.getNodeInstallDirectory().getOrNull())
            .isEqualTo(extension.getNodeInstallDirectory().getOrNull());
        assertThat(frontendAssembleTask.getYarnEnabled().get()).isEqualTo(extension.getYarnEnabled().get());
        assertThat(frontendAssembleTask.getAssembleScript().getOrNull())
            .isEqualTo(extension.getAssembleScript().getOrNull());
        assertThat(frontendAssembleTask.getPackageJsonDirectory().get())
            .isEqualTo(extension.getPackageJsonDirectory().get());
        ...
        assertThat(project.getTasks().named(BasePlugin.ASSEMBLE_TASK_NAME).get().getDependsOn())
        ...
        final CheckTask frontendCheckTask = project
            ...
            .get();
        assertThat(frontendCheckTask.getNodeInstallDirectory().getOrNull())
            .isEqualTo(extension.getNodeInstallDirectory().getOrNull());
        ...
        assertThat(frontendCheckTask.getPackageJsonDirectory().get())
            .isEqualTo(extension.getPackageJsonDirectory().get());
        ...
        assertThat(project.getTasks().named(LifecycleBasePlugin.CHECK_TASK_NAME).get().getDependsOn())
        ...
        final PublishTask frontendPublishTask = project
            ...
            .get();
        assertThat(frontendPublishTask.getNodeInstallDirectory().getOrNull())
            .isEqualTo(extension.getNodeInstallDirectory().getOrNull());
        assertThat(frontendPublishTask.getYarnEnabled().get()).isEqualTo(extension.getYarnEnabled().get());
        assertThat(frontendPublishTask.getPublishScript().getOrNull())
            .isEqualTo(extension.getPublishScript().getOrNull());
        assertThat(frontendPublishTask.getPackageJsonDirectory().get())
            .isEqualTo(extension.getPackageJsonDirectory().get());
        ...
        assertThat(project.getTasks().named(PublishingPlugin.PUBLISH_LIFECYCLE_TASK_NAME).get().getDependsOn())
            .contains(frontendPublishTask.getName());
    }
}
