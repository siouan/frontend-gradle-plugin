...
[![Latest release 1.1.4](https://img.shields.io/badge/Latest%20release-1.1.4-blue.svg)](https://github.com/Siouan/frontend-gradle-plugin/releases/tag/v1.1.4)
...
// build.gradle
plugins {
    id 'org.siouan.frontend' version '1.1.4'
}
```
...
buildscript {
    ...
    dependencies {
        classpath 'org.siouan:frontend-gradle-plugin:1.1.4'
    }
}
